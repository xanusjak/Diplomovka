//
//  ARMultipeerViewController.swift
//  ORAAR
//
...
class ARMultipeerViewController: UIViewController, ARSCNViewDelegate, ARSessionDelegate  {
    ...
    func renderer(_ renderer: SCNSceneRenderer, didAdd node: SCNNode, for anchor: ARAnchor) {
        if let name = anchor.name, name.hasPrefix("panda"), let myNode = loadSCNNode(withName: "toy_drummer") {
